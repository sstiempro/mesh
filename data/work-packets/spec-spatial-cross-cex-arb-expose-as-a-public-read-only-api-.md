# Work packet — Spatial (cross-CEX) arb → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Spatial (cross-CEX) arb → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:spatial-arb
- **drafted:** 2026-06-30T17:30:35.080Z
- **routing (needs):** build
