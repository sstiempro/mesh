# Work packet — Social-listening signal bot → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Social-listening signal bot → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp87
- **drafted:** 2026-06-30T09:27:13.615Z
- **routing (needs):** build
