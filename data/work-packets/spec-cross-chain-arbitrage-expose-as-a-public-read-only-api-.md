# Work packet — Cross-chain arbitrage → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Cross-chain arbitrage → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:cross-chain-arb
- **drafted:** 2026-06-30T14:03:19.519Z
- **routing (needs):** build
