# Work packet — Bug-bounty triage for projects → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Bug-bounty triage for projects → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp93
- **drafted:** 2026-06-29T18:39:15.460Z
