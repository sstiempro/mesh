# Work packet — Real-yield data feed → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Real-yield data feed → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp11
- **drafted:** 2026-06-29T15:33:42.680Z
