# Work packet — Arb/spread data → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Arb/spread data → expose as a public read-only API endpoint + rate-limit`
