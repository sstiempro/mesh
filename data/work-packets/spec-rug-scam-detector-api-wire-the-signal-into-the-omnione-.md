# Work packet — Rug/scam detector API → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Rug/scam detector API → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp6
- **drafted:** 2026-06-29T16:23:55.027Z
- **routing (needs):** build
