# Work packet — RWA / tokenized T-bills → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:RWA / tokenized T-bills → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:rwa-yield
- **drafted:** 2026-06-30T07:54:20.777Z
- **routing (needs):** build
