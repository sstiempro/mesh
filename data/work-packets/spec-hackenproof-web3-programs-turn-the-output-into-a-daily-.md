# Work packet — HackenProof / web3 programs → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:HackenProof / web3 programs → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp3
- **drafted:** 2026-06-30T08:40:56.456Z
