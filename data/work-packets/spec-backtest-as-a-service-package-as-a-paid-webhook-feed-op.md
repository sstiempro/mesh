# Work packet — Backtest-as-a-service → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Backtest-as-a-service → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp40
- **drafted:** 2026-06-30T20:52:39.652Z
- **routing (needs):** build
