# Work packet — Run a trading bot, charge fee → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Run a trading bot, charge fee → backtest the signal against stored candle history for an edge stat`
