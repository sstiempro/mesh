# Work packet — Treasury dashboard (DAOs/SMBs) → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Treasury dashboard (DAOs/SMBs) → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp73
- **drafted:** 2026-06-29T21:01:33.791Z
- **routing (needs):** build
