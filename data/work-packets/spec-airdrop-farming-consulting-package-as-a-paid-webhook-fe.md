# Work packet — Airdrop-farming consulting → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Airdrop-farming consulting → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp92
- **drafted:** 2026-06-30T18:00:14.676Z
- **routing (needs):** build
