# Work packet — Stablecoin depeg monitor → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Stablecoin depeg monitor → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp20
- **drafted:** 2026-06-30T11:48:40.290Z
