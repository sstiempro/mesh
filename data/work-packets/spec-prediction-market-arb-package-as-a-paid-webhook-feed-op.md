# Work packet — Prediction-market arb → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Prediction-market arb → package as a paid webhook feed (open-core: free digest, pro realtime)`
