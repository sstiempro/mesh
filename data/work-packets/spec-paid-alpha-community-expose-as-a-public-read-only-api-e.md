# Work packet — Paid alpha community → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Paid alpha community → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp67
- **drafted:** 2026-06-30T17:47:59.620Z
- **routing (needs):** build
