# Work packet — Webhook/event infra → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Webhook/event infra → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp59
- **drafted:** 2026-06-30T18:24:36.557Z
- **routing (needs):** build
