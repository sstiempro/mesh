# Work packet — MEV-aware order timing → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:MEV-aware order timing → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp47
- **drafted:** 2026-06-30T11:38:11.984Z
- **routing (needs):** build
