# Work packet — Validator commission → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Validator commission → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:validator-commission
- **drafted:** 2026-06-30T12:06:29.791Z
- **routing (needs):** build
