# Work packet — Treasury dashboard (DAOs/SMBs) → cross-reference two monitors for a confluence alert

- **sig:** `spec:Treasury dashboard (DAOs/SMBs) → cross-reference two monitors for a confluence alert`
