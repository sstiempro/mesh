# Work packet — Real-yield data feed → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Real-yield data feed → wire the signal into the omnione paper-sim as an entry gate`
