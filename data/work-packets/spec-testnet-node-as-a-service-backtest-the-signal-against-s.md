# Work packet — Testnet node-as-a-service → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Testnet node-as-a-service → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp58
- **drafted:** 2026-06-29T15:51:18.905Z
