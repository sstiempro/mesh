# Work packet — Liquidation keeper → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Liquidation keeper → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:liquidation-bot
- **drafted:** 2026-06-29T15:51:18.906Z
- **routing (needs):** build
