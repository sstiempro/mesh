# Work packet — Course / cohort → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Course / cohort → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp66
- **drafted:** 2026-06-30T12:52:52.454Z
- **routing (needs):** build
