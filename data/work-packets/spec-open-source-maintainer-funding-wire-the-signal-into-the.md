# Work packet — Open-source maintainer funding → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Open-source maintainer funding → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp100
- **drafted:** 2026-06-30T20:33:22.604Z
- **routing (needs):** build
