# Work packet — RWA / tokenized T-bills → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:RWA / tokenized T-bills → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:rwa-yield
- **drafted:** 2026-06-30T12:58:44.162Z
- **routing (needs):** build
