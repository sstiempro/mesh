# Work packet — Pendle PT/YT yield trade → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Pendle PT/YT yield trade → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:pendle-yield-trade
- **drafted:** 2026-06-30T07:22:17.936Z
- **routing (needs):** build
