# Work packet — Liquidation keeper → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Liquidation keeper → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:liquidation-bot
- **drafted:** 2026-06-29T14:58:13.616Z
