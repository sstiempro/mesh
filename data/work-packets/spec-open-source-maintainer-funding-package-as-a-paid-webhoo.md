# Work packet — Open-source maintainer funding → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Open-source maintainer funding → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp100
- **drafted:** 2026-06-30T07:33:54.614Z
- **routing (needs):** build
