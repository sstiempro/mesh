# Work packet — Resolution-info edge → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Resolution-info edge → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** edge:pm-resolution-edge
- **drafted:** 2026-06-30T05:37:49.575Z
