# Work packet — Persistence/“is it real” scores → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Persistence/“is it real” scores → wire the signal into the omnione paper-sim as an entry gate`
