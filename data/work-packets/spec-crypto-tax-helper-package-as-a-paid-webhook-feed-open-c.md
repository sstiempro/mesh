# Work packet — Crypto tax helper → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Crypto tax helper → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp33
- **drafted:** 2026-06-29T15:57:35.938Z
- **routing (needs):** build
