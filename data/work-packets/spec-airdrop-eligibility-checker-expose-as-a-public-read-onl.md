# Work packet — Airdrop eligibility checker → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Airdrop eligibility checker → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp31
- **drafted:** 2026-06-30T12:47:06.691Z
- **routing (needs):** build
