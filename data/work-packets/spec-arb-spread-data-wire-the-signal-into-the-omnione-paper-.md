# Work packet — Arb/spread data → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Arb/spread data → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp14
- **drafted:** 2026-06-30T13:39:43.412Z
- **routing (needs):** build
