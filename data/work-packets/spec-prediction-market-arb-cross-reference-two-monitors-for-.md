# Work packet — Prediction-market arb → cross-reference two monitors for a confluence alert

- **sig:** `spec:Prediction-market arb → cross-reference two monitors for a confluence alert`
- **source avenue:** edge:polymarket-arb
- **drafted:** 2026-06-30T19:03:00.138Z
- **routing (needs):** build
