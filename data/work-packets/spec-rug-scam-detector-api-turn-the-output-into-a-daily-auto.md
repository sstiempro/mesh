# Work packet — Rug/scam detector API → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Rug/scam detector API → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp6
- **drafted:** 2026-06-30T17:47:59.617Z
