# Work packet — Cross-chain bridge router → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Cross-chain bridge router → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp38
- **drafted:** 2026-06-29T16:23:55.028Z
- **routing (needs):** build
