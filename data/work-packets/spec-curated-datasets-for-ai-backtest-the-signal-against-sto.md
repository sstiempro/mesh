# Work packet — Curated datasets for AI → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Curated datasets for AI → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp15
- **drafted:** 2026-06-30T18:50:02.547Z
