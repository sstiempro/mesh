# Work packet — Rug/scam detector API → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Rug/scam detector API → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp6
- **drafted:** 2026-06-29T17:23:43.814Z
- **routing (needs):** build
