# Work packet — Data-availability/relayer node → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Data-availability/relayer node → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp55
- **drafted:** 2026-06-29T21:47:46.978Z
- **routing (needs):** build
