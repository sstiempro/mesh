# Work packet — Signal/alpha feed (paid) → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Signal/alpha feed (paid) → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp41
- **drafted:** 2026-06-30T11:38:11.985Z
- **routing (needs):** build
