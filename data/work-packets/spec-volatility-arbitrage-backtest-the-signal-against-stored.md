# Work packet — Volatility arbitrage → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Volatility arbitrage → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:vol-arb
- **drafted:** 2026-06-30T20:52:39.654Z
