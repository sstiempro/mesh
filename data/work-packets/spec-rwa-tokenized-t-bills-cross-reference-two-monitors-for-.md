# Work packet — RWA / tokenized T-bills → cross-reference two monitors for a confluence alert

- **sig:** `spec:RWA / tokenized T-bills → cross-reference two monitors for a confluence alert`
- **source avenue:** edge:rwa-yield
- **drafted:** 2026-07-01T11:28:04.851Z
- **routing (needs):** build
