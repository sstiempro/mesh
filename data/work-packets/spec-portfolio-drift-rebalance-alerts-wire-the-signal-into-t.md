# Work packet — Portfolio drift/rebalance alerts → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Portfolio drift/rebalance alerts → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp28
- **drafted:** 2026-06-30T08:29:27.795Z
- **routing (needs):** build
