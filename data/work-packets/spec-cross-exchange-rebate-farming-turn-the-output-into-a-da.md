# Work packet — Cross-exchange rebate farming → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Cross-exchange rebate farming → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp49
- **drafted:** 2026-06-30T15:20:23.361Z
