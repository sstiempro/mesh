# Work packet — Regime-router signals → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Regime-router signals → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp50
- **drafted:** 2026-06-30T17:13:01.422Z
- **routing (needs):** build
