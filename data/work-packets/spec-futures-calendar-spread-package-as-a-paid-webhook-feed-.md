# Work packet — Futures calendar spread → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Futures calendar spread → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:calendar-spread
- **drafted:** 2026-06-29T15:21:52.318Z
- **routing (needs):** build
