# Work packet — Sponsored dashboards → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Sponsored dashboards → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp68
- **drafted:** 2026-06-29T16:48:33.389Z
- **routing (needs):** build
