# Work packet — Resolution-info edge → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Resolution-info edge → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:pm-resolution-edge
- **drafted:** 2026-06-30T20:33:22.601Z
- **routing (needs):** build
