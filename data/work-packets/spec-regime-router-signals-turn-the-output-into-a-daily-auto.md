# Work packet — Regime-router signals → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Regime-router signals → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp50
- **drafted:** 2026-06-30T19:09:21.156Z
