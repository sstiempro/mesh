# Work packet — Impermanent-loss calculator → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Impermanent-loss calculator → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp32
- **drafted:** 2026-06-29T17:52:16.856Z
