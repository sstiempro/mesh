# Work packet — Auto-claim assistant (guarded) → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Auto-claim assistant (guarded) → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp82
- **drafted:** 2026-06-30T07:48:23.143Z
