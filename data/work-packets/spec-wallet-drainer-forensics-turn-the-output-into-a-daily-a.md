# Work packet — Wallet-drainer forensics → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Wallet-drainer forensics → turn the output into a daily auto-posted thread (attention → audience)`
