# Work packet — Airdrop-deadline alerts → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Airdrop-deadline alerts → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp27
- **drafted:** 2026-06-30T19:34:56.423Z
- **routing (needs):** build
