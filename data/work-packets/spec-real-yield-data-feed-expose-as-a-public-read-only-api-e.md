# Work packet — Real-yield data feed → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Real-yield data feed → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp11
- **drafted:** 2026-06-30T07:22:17.938Z
- **routing (needs):** build
