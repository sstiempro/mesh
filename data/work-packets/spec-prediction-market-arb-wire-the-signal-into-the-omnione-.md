# Work packet — Prediction-market arb → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Prediction-market arb → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:polymarket-arb
- **drafted:** 2026-06-30T09:32:56.044Z
- **routing (needs):** build
