# Work packet — Airdrop-radar feed → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Airdrop-radar feed → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp13
- **drafted:** 2026-06-30T16:01:41.424Z
- **routing (needs):** build
