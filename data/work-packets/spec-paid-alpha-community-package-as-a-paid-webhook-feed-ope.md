# Work packet — Paid alpha community → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Paid alpha community → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp67
- **drafted:** 2026-06-30T15:27:06.560Z
- **routing (needs):** build
