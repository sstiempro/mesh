# Work packet — Invoicing/payments in stables → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Invoicing/payments in stables → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp72
- **drafted:** 2026-06-30T15:20:23.358Z
- **routing (needs):** build
