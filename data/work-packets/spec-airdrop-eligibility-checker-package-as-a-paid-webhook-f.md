# Work packet — Airdrop eligibility checker → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Airdrop eligibility checker → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp31
- **drafted:** 2026-06-30T20:20:32.422Z
- **routing (needs):** build
