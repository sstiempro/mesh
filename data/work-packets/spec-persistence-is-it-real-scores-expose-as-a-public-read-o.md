# Work packet — Persistence/“is it real” scores → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Persistence/“is it real” scores → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp16
- **drafted:** 2026-06-29T16:23:55.029Z
- **routing (needs):** build
