# Work packet — Grant-writing as a service → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Grant-writing as a service → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp91
- **drafted:** 2026-06-30T13:57:26.433Z
