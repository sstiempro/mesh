# Work packet — Wallet-drainer forensics → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Wallet-drainer forensics → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp10
- **drafted:** 2026-06-29T17:46:34.675Z
- **routing (needs):** build
