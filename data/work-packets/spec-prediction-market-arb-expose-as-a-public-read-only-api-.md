# Work packet — Prediction-market arb → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Prediction-market arb → expose as a public read-only API endpoint + rate-limit`
