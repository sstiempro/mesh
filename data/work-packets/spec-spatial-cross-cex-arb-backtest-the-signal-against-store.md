# Work packet — Spatial (cross-CEX) arb → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Spatial (cross-CEX) arb → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:spatial-arb
- **drafted:** 2026-06-30T18:56:36.918Z
