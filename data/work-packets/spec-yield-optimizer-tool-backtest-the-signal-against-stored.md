# Work packet — Yield optimizer tool → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Yield optimizer tool → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp35
- **drafted:** 2026-06-29T23:25:55.078Z
