# Work packet — Treasury dashboard (DAOs/SMBs) → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Treasury dashboard (DAOs/SMBs) → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp73
- **drafted:** 2026-06-30T20:46:07.178Z
