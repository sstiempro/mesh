# Work packet — Cross-chain bridge router → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Cross-chain bridge router → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp38
- **drafted:** 2026-06-30T08:00:16.237Z
