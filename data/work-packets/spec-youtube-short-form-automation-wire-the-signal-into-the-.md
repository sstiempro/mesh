# Work packet — YouTube/short-form automation → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:YouTube/short-form automation → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp65
- **drafted:** 2026-06-29T15:21:52.319Z
- **routing (needs):** build
