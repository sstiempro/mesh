# Work packet — Telegram trading bot (fee share) → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Telegram trading bot (fee share) → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp81
- **drafted:** 2026-06-30T18:12:05.046Z
- **routing (needs):** build
