# Work packet — Auto-claim assistant (guarded) → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Auto-claim assistant (guarded) → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp82
- **drafted:** 2026-06-30T13:33:59.891Z
- **routing (needs):** build
