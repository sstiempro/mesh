# Work packet — Card-spend optimizer → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Card-spend optimizer → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp78
- **drafted:** 2026-06-30T00:50:40.071Z
- **routing (needs):** build
