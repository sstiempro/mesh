# Work packet — Whale-move alerts → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Whale-move alerts → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp29
- **drafted:** 2026-06-30T12:52:52.456Z
- **routing (needs):** build
