# Work packet — Resolution-info edge → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Resolution-info edge → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:pm-resolution-edge
- **drafted:** 2026-06-30T04:43:20.472Z
- **routing (needs):** build
