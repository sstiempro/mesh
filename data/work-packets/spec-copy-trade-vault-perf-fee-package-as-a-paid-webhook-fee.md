# Work packet — Copy-trade vault (perf fee) → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Copy-trade vault (perf fee) → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:copy-trade-vault
- **drafted:** 2026-06-30T14:09:51.160Z
- **routing (needs):** build
