# Work packet — Ambassador / KOL technical → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Ambassador / KOL technical → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp63
- **drafted:** 2026-06-30T18:24:36.559Z
- **routing (needs):** build
