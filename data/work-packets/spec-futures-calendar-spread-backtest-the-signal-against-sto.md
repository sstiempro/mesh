# Work packet — Futures calendar spread → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Futures calendar spread → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:calendar-spread
- **drafted:** 2026-06-30T09:15:31.494Z
