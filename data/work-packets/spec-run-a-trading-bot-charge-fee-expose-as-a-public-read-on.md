# Work packet — Run a trading bot, charge fee → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Run a trading bot, charge fee → expose as a public read-only API endpoint + rate-limit`
