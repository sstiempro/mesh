# Work packet — Arb/spread data → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Arb/spread data → turn the output into a daily auto-posted thread (attention → audience)`
