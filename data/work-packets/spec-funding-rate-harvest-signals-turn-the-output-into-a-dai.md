# Work packet — Funding-rate harvest signals → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Funding-rate harvest signals → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp43
- **drafted:** 2026-07-01T11:14:32.328Z
