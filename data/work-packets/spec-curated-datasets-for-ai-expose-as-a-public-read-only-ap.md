# Work packet — Curated datasets for AI → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Curated datasets for AI → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp15
- **drafted:** 2026-06-30T08:12:08.442Z
- **routing (needs):** build
