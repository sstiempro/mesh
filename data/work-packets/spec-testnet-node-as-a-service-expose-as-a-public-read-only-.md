# Work packet — Testnet node-as-a-service → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Testnet node-as-a-service → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp58
- **drafted:** 2026-06-30T14:59:35.317Z
- **routing (needs):** build
