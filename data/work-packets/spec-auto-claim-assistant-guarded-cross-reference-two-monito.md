# Work packet — Auto-claim assistant (guarded) → cross-reference two monitors for a confluence alert

- **sig:** `spec:Auto-claim assistant (guarded) → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp82
- **drafted:** 2026-06-30T08:35:12.809Z
- **routing (needs):** build
