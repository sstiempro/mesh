# Work packet — Futures calendar spread → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Futures calendar spread → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:calendar-spread
- **drafted:** 2026-06-29T16:42:20.376Z
- **routing (needs):** build
