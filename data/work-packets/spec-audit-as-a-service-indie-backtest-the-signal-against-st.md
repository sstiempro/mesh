# Work packet — Audit-as-a-service (indie) → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Audit-as-a-service (indie) → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp4
- **drafted:** 2026-06-30T18:37:13.496Z
