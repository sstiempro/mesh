# Work packet — Sybil-detection for protocols → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Sybil-detection for protocols → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp97
- **drafted:** 2026-06-30T08:29:27.791Z
- **routing (needs):** build
