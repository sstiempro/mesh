# Work packet — Cross-chain arbitrage → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Cross-chain arbitrage → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:cross-chain-arb
- **drafted:** 2026-06-30T19:54:31.071Z
- **routing (needs):** build
