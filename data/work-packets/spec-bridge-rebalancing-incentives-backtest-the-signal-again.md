# Work packet — Bridge-rebalancing incentives → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Bridge-rebalancing incentives → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:bridge-incentive
- **drafted:** 2026-06-29T15:27:48.499Z
