# Work packet — Wallet bundle/health scanner → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Wallet bundle/health scanner → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp36
- **drafted:** 2026-06-30T16:01:41.421Z
- **routing (needs):** build
