# Work packet — Card-spend optimizer → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Card-spend optimizer → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp78
- **drafted:** 2026-06-30T06:21:17.256Z
