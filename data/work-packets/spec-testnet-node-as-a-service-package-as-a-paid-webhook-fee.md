# Work packet — Testnet node-as-a-service → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Testnet node-as-a-service → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp58
- **drafted:** 2026-06-30T07:48:23.137Z
- **routing (needs):** build
