# Work packet — Wallet watchtower → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Wallet watchtower → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp21
- **drafted:** 2026-06-30T20:46:07.179Z
- **routing (needs):** build
