# Work packet — Compliance/tax-lot reporter → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Compliance/tax-lot reporter → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp80
- **drafted:** 2026-06-30T18:43:34.309Z
- **routing (needs):** build
