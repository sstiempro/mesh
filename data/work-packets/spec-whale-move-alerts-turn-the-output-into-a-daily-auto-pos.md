# Work packet — Whale-move alerts → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Whale-move alerts → turn the output into a daily auto-posted thread (attention → audience)`
