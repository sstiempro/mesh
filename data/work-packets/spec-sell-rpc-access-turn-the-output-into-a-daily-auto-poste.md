# Work packet — Sell RPC access → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Sell RPC access → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** edge:rpc-node-service
- **drafted:** 2026-06-30T20:20:32.424Z
