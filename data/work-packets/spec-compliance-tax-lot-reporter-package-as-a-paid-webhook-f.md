# Work packet — Compliance/tax-lot reporter → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Compliance/tax-lot reporter → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp80
- **drafted:** 2026-06-29T17:17:51.730Z
- **routing (needs):** build
