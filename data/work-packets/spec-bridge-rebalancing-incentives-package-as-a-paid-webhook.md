# Work packet — Bridge-rebalancing incentives → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Bridge-rebalancing incentives → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:bridge-incentive
- **drafted:** 2026-06-30T18:24:36.560Z
- **routing (needs):** build
