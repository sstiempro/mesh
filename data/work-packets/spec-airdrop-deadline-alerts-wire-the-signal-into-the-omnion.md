# Work packet — Airdrop-deadline alerts → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Airdrop-deadline alerts → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp27
- **drafted:** 2026-06-30T15:55:29.306Z
- **routing (needs):** build
