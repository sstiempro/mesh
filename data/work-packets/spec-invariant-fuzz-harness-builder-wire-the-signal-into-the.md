# Work packet — Invariant/fuzz harness builder → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Invariant/fuzz harness builder → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp9
- **drafted:** 2026-06-29T15:45:30.231Z
- **routing (needs):** build
