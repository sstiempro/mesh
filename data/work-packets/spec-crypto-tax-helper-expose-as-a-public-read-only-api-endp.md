# Work packet — Crypto tax helper → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Crypto tax helper → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp33
- **drafted:** 2026-06-30T14:36:53.615Z
- **routing (needs):** build
