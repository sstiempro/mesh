# Work packet — New-listing sniper signals → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:New-listing sniper signals → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp45
- **drafted:** 2026-06-30T16:14:36.547Z
- **routing (needs):** build
