# Work packet — Sentiment/pulse API → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Sentiment/pulse API → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp12
- **drafted:** 2026-06-29T16:30:07.456Z
- **routing (needs):** build
