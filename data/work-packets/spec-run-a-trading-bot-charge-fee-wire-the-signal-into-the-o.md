# Work packet — Run a trading bot, charge fee → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Run a trading bot, charge fee → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:trading-bot-fee
- **drafted:** 2026-06-30T20:26:58.622Z
- **routing (needs):** build
