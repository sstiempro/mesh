# Work packet — New-listing sniper signals → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:New-listing sniper signals → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp45
- **drafted:** 2026-06-30T07:16:15.811Z
- **routing (needs):** build
