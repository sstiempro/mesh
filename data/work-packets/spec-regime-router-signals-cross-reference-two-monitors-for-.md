# Work packet — Regime-router signals → cross-reference two monitors for a confluence alert

- **sig:** `spec:Regime-router signals → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp50
- **drafted:** 2026-06-29T16:17:35.033Z
- **routing (needs):** build
