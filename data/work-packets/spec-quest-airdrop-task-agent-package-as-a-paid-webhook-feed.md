# Work packet — Quest/airdrop task agent → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Quest/airdrop task agent → package as a paid webhook feed (open-core: free digest, pro realtime)`
