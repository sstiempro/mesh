# Work packet — Payroll in crypto → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Payroll in crypto → turn the output into a daily auto-posted thread (attention → audience)`
