# Work packet — Funding-rate harvest signals → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Funding-rate harvest signals → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp43
- **drafted:** 2026-06-30T16:08:09.127Z
