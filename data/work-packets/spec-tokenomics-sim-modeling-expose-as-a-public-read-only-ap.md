# Work packet — Tokenomics/sim modeling → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Tokenomics/sim modeling → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp94
- **drafted:** 2026-06-30T07:10:30.547Z
- **routing (needs):** build
