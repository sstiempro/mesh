# Work packet — Payroll in crypto → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Payroll in crypto → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp74
- **drafted:** 2026-06-30T15:27:06.563Z
- **routing (needs):** build
