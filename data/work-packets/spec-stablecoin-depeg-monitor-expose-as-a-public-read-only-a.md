# Work packet — Stablecoin depeg monitor → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Stablecoin depeg monitor → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp20
- **drafted:** 2026-06-30T17:30:35.077Z
- **routing (needs):** build
