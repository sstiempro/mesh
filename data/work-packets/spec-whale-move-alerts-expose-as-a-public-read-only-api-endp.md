# Work packet — Whale-move alerts → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Whale-move alerts → expose as a public read-only API endpoint + rate-limit`
