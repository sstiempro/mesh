# Work packet — New-listing sniper signals → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:New-listing sniper signals → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp45
- **drafted:** 2026-06-30T03:05:17.311Z
- **routing (needs):** build
