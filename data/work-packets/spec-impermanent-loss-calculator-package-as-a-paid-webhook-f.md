# Work packet — Impermanent-loss calculator → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Impermanent-loss calculator → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp32
- **drafted:** 2026-06-30T08:00:16.241Z
- **routing (needs):** build
