# Work packet — Quest/airdrop task agent → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Quest/airdrop task agent → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp84
- **drafted:** 2026-06-30T13:10:28.710Z
