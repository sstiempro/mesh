# Work packet — Spatial (cross-CEX) arb → cross-reference two monitors for a confluence alert

- **sig:** `spec:Spatial (cross-CEX) arb → cross-reference two monitors for a confluence alert`
- **source avenue:** edge:spatial-arb
- **drafted:** 2026-06-30T12:12:29.039Z
- **routing (needs):** build
