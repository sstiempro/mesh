# Work packet — CEX↔DEX arbitrage → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:CEX↔DEX arbitrage → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:cex-dex-arb
- **drafted:** 2026-06-29T15:04:05.779Z
