# Work packet — Onchain alert builder (no-code) → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Onchain alert builder (no-code) → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp39
- **drafted:** 2026-06-30T07:28:10.923Z
- **routing (needs):** build
