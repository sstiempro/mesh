# Work packet — Data-availability/relayer node → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Data-availability/relayer node → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp55
- **drafted:** 2026-06-30T07:08:35.842Z
- **routing (needs):** build
