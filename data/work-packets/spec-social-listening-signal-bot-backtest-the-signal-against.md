# Work packet — Social-listening signal bot → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Social-listening signal bot → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp87
- **drafted:** 2026-06-30T14:59:35.314Z
