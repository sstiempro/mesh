# Work packet — Liquidation keeper → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Liquidation keeper → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:liquidation-bot
- **drafted:** 2026-06-30T13:28:04.995Z
- **routing (needs):** build
