# Work packet — Crypto accounting/bookkeeping → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Crypto accounting/bookkeeping → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp71
- **drafted:** 2026-06-29T16:17:35.030Z
- **routing (needs):** build
