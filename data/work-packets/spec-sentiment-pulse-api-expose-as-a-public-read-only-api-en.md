# Work packet — Sentiment/pulse API → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Sentiment/pulse API → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp12
- **drafted:** 2026-06-30T12:41:19.523Z
- **routing (needs):** build
