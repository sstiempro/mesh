# Work packet — Sell RPC access → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Sell RPC access → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:rpc-node-service
- **drafted:** 2026-06-29T15:39:34.087Z
- **routing (needs):** build
