# Work packet — InfoFi / Cookie.fun content → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:InfoFi / Cookie.fun content → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp64
- **drafted:** 2026-06-29T17:29:26.109Z
- **routing (needs):** build
