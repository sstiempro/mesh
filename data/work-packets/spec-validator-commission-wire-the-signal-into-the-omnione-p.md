# Work packet — Validator commission → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Validator commission → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:validator-commission
- **drafted:** 2026-06-30T18:06:10.048Z
- **routing (needs):** build
