# Work packet — Course / cohort → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Course / cohort → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp66
- **drafted:** 2026-06-30T14:38:14.363Z
- **routing (needs):** build
