# Work packet — Regime-router signals → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Regime-router signals → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp50
- **drafted:** 2026-06-29T14:58:13.618Z
