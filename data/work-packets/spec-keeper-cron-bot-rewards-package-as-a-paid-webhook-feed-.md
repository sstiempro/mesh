# Work packet — Keeper/cron bot rewards → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Keeper/cron bot rewards → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:keeper-bot-rewards
- **drafted:** 2026-06-29T15:04:05.781Z
- **routing (needs):** build
