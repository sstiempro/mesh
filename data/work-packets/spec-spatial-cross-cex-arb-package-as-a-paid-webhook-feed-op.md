# Work packet — Spatial (cross-CEX) arb → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Spatial (cross-CEX) arb → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:spatial-arb
- **drafted:** 2026-06-30T13:51:33.794Z
- **routing (needs):** build
