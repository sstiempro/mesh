# Work packet — YouTube/short-form automation → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:YouTube/short-form automation → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp65
- **drafted:** 2026-06-30T19:54:31.069Z
- **routing (needs):** build
