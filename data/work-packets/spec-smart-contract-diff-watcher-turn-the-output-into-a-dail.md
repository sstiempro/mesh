# Work packet — Smart-contract diff watcher → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Smart-contract diff watcher → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp8
- **drafted:** 2026-06-30T20:39:42.136Z
