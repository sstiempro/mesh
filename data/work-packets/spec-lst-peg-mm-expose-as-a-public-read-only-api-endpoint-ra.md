# Work packet — LST peg MM → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:LST peg MM → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:lst-peg-mm
- **drafted:** 2026-06-30T19:41:40.204Z
- **routing (needs):** build
