# Work packet — Auto-claim assistant (guarded) → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Auto-claim assistant (guarded) → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp82
- **drafted:** 2026-06-30T19:09:21.153Z
- **routing (needs):** build
