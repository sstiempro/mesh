# Work packet — Invariant/fuzz harness builder → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Invariant/fuzz harness builder → expose as a public read-only API endpoint + rate-limit`
