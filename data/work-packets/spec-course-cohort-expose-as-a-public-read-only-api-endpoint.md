# Work packet — Course / cohort → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Course / cohort → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp66
- **drafted:** 2026-06-30T19:28:23.759Z
- **routing (needs):** build
