# Work packet — DePIN earnings benchmark → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:DePIN earnings benchmark → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp17
- **drafted:** 2026-06-30T17:19:03.307Z
