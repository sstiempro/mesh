# Work packet — Snapshot/archive service → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Snapshot/archive service → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp57
- **drafted:** 2026-06-30T12:12:29.037Z
- **routing (needs):** build
