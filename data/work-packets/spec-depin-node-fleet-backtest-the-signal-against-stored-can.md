# Work packet — DePIN node fleet → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:DePIN node fleet → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp54
- **drafted:** 2026-06-30T07:48:23.149Z
