# Work packet — Smart-contract diff watcher → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Smart-contract diff watcher → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp8
- **drafted:** 2026-06-29T15:33:42.678Z
- **routing (needs):** build
