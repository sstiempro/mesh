# Work packet — News-latency repricing → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:News-latency repricing → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:pm-news-latency
- **drafted:** 2026-06-30T18:50:02.544Z
- **routing (needs):** build
