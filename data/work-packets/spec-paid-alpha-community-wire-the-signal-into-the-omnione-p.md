# Work packet — Paid alpha community → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Paid alpha community → wire the signal into the omnione paper-sim as an entry gate`
