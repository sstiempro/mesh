# Work packet — Node/validator downtime alerts → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Node/validator downtime alerts → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp30
- **drafted:** 2026-06-30T08:58:15.331Z
- **routing (needs):** build
