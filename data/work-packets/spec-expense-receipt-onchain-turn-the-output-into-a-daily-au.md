# Work packet — Expense/receipt → onchain → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Expense/receipt → onchain → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp75
- **drafted:** 2026-06-29T16:42:20.377Z
