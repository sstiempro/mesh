# Work packet — Stable mint/redeem arb → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Stable mint/redeem arb → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:stable-mint-redeem-arb
- **drafted:** 2026-06-29T15:57:35.940Z
- **routing (needs):** build
