# Work packet — DePIN node fleet → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:DePIN node fleet → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp54
- **drafted:** 2026-06-30T02:28:50.835Z
- **routing (needs):** build
