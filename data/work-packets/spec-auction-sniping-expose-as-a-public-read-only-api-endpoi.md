# Work packet — Auction sniping → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Auction sniping → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:auction-sniping
- **drafted:** 2026-06-30T18:00:14.678Z
- **routing (needs):** build
