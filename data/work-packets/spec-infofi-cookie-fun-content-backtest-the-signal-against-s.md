# Work packet — InfoFi / Cookie.fun content → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:InfoFi / Cookie.fun content → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp64
- **drafted:** 2026-06-30T20:58:58.946Z
