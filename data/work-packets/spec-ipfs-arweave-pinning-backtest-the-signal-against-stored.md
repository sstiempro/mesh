# Work packet — IPFS/Arweave pinning → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:IPFS/Arweave pinning → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp60
- **drafted:** 2026-06-29T19:25:30.388Z
