# Work packet — Node/validator downtime alerts → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Node/validator downtime alerts → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp30
- **drafted:** 2026-06-30T11:48:40.291Z
- **routing (needs):** build
