# Work packet — Quest/airdrop task agent → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Quest/airdrop task agent → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp84
- **drafted:** 2026-06-30T16:08:09.129Z
- **routing (needs):** build
