# Work packet — Rug/scam detector API → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Rug/scam detector API → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp6
- **drafted:** 2026-06-30T00:04:21.680Z
