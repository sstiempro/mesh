# Work packet — Concentrated-liquidity LP → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Concentrated-liquidity LP → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:concentrated-liquidity
- **drafted:** 2026-06-30T17:01:29.635Z
- **routing (needs):** build
