# Work packet — Rug/scam detector API → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Rug/scam detector API → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp6
- **drafted:** 2026-06-29T15:15:54.782Z
- **routing (needs):** build
