# Work packet — Cross-exchange rebate farming → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Cross-exchange rebate farming → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp49
- **drafted:** 2026-06-30T17:24:47.642Z
