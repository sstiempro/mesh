# Work packet — Testnet node-as-a-service → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Testnet node-as-a-service → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp58
- **drafted:** 2026-06-29T17:17:51.729Z
- **routing (needs):** build
