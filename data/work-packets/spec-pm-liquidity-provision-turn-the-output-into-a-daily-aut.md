# Work packet — PM liquidity provision → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:PM liquidity provision → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** edge:pm-liquidity-provision
- **drafted:** 2026-06-30T00:04:21.679Z
