# Work packet — HackenProof / web3 programs → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:HackenProof / web3 programs → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp3
- **drafted:** 2026-06-30T19:48:03.728Z
- **routing (needs):** build
