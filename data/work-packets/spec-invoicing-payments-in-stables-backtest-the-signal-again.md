# Work packet — Invoicing/payments in stables → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Invoicing/payments in stables → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp72
- **drafted:** 2026-06-30T13:22:19.677Z
