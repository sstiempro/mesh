# Work packet — PM liquidity provision → cross-reference two monitors for a confluence alert

- **sig:** `spec:PM liquidity provision → cross-reference two monitors for a confluence alert`
- **source avenue:** edge:pm-liquidity-provision
- **drafted:** 2026-06-30T08:40:56.457Z
- **routing (needs):** build
