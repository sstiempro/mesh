# Work packet — Yield-change alerts → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Yield-change alerts → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp26
- **drafted:** 2026-06-29T14:58:13.617Z
- **routing (needs):** build
