# Work packet — Social-listening signal bot → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Social-listening signal bot → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp87
- **drafted:** 2026-06-30T06:21:17.257Z
- **routing (needs):** build
