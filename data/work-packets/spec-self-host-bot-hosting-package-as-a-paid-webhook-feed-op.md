# Work packet — Self-host bot hosting → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Self-host bot hosting → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp56
- **drafted:** 2026-06-30T19:48:03.725Z
- **routing (needs):** build
