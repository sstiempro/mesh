# Work packet — Cross-chain arbitrage → cross-reference two monitors for a confluence alert

- **sig:** `spec:Cross-chain arbitrage → cross-reference two monitors for a confluence alert`
- **source avenue:** edge:cross-chain-arb
- **drafted:** 2026-06-29T15:39:34.085Z
- **routing (needs):** build
