# Work packet — Protocol deep-dive reports → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Protocol deep-dive reports → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp62
- **drafted:** 2026-06-30T08:12:08.441Z
