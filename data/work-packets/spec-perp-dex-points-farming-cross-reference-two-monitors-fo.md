# Work packet — Perp-DEX points farming → cross-reference two monitors for a confluence alert

- **sig:** `spec:Perp-DEX points farming → cross-reference two monitors for a confluence alert`
- **source avenue:** edge:perp-dex-points
- **drafted:** 2026-06-30T16:32:12.113Z
- **routing (needs):** build
