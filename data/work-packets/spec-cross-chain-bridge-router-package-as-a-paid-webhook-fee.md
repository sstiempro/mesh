# Work packet — Cross-chain bridge router → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Cross-chain bridge router → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp38
- **drafted:** 2026-06-30T09:04:01.440Z
- **routing (needs):** build
