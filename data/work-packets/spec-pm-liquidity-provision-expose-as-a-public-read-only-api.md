# Work packet — PM liquidity provision → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:PM liquidity provision → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:pm-liquidity-provision
- **drafted:** 2026-06-30T14:23:30.133Z
- **routing (needs):** build
