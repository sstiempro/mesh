# Work packet — Cross-chain bridge router → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Cross-chain bridge router → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp38
- **drafted:** 2026-06-29T17:12:04.856Z
- **routing (needs):** build
