# Work packet — Cross-exchange rebate farming → cross-reference two monitors for a confluence alert

- **sig:** `spec:Cross-exchange rebate farming → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp49
- **drafted:** 2026-06-30T17:36:20.837Z
- **routing (needs):** build
