# Work packet — Curated datasets for AI → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Curated datasets for AI → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp15
- **drafted:** 2026-06-30T07:39:42.665Z
- **routing (needs):** build
