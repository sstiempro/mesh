# Work packet — Backtest-as-a-service → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Backtest-as-a-service → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp40
- **drafted:** 2026-06-30T16:49:52.246Z
- **routing (needs):** build
