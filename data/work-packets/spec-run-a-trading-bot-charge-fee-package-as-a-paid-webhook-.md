# Work packet — Run a trading bot, charge fee → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Run a trading bot, charge fee → package as a paid webhook feed (open-core: free digest, pro realtime)`
