# Work packet — Yield-change alerts → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Yield-change alerts → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp26
- **drafted:** 2026-06-30T12:35:36.871Z
- **routing (needs):** build
