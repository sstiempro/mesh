# Work packet — Vote-bribe markets → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Vote-bribe markets → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:vetoken-bribes
- **drafted:** 2026-06-30T14:16:44.540Z
- **routing (needs):** build
