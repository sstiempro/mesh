# Work packet — Points arbitrage → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Points arbitrage → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:points-arbitrage
- **drafted:** 2026-06-30T12:47:06.692Z
- **routing (needs):** build
