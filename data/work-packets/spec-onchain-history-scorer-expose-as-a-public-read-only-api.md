# Work packet — Onchain-history scorer → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Onchain-history scorer → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp18
- **drafted:** 2026-06-30T16:43:49.099Z
- **routing (needs):** build
