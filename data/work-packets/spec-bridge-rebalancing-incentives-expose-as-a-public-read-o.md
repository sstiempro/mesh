# Work packet — Bridge-rebalancing incentives → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Bridge-rebalancing incentives → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:bridge-incentive
- **drafted:** 2026-06-30T15:06:31.840Z
- **routing (needs):** build
