# Work packet — Bug-bounty triage for projects → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Bug-bounty triage for projects → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp93
- **drafted:** 2026-06-30T17:01:29.633Z
- **routing (needs):** build
