# Work packet — Onchain reputation/attestation → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Onchain reputation/attestation → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp96
- **drafted:** 2026-06-29T17:23:43.818Z
