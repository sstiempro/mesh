# Work packet — Open-source maintainer funding → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Open-source maintainer funding → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp100
- **drafted:** 2026-06-29T16:04:19.893Z
- **routing (needs):** build
