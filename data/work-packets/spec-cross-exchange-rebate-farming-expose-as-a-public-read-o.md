# Work packet — Cross-exchange rebate farming → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Cross-exchange rebate farming → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp49
- **drafted:** 2026-06-30T13:51:33.795Z
- **routing (needs):** build
