# Work packet — News-latency repricing → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:News-latency repricing → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:pm-news-latency
- **drafted:** 2026-06-30T20:07:38.324Z
- **routing (needs):** build
