# Work packet — Self-host bot hosting → cross-reference two monitors for a confluence alert

- **sig:** `spec:Self-host bot hosting → cross-reference two monitors for a confluence alert`
