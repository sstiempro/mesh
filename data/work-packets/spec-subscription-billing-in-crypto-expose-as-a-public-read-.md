# Work packet — Subscription-billing in crypto → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Subscription-billing in crypto → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp77
- **drafted:** 2026-06-30T13:10:28.708Z
- **routing (needs):** build
