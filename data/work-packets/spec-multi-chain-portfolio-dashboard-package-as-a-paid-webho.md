# Work packet — Multi-chain portfolio dashboard → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Multi-chain portfolio dashboard → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp34
- **drafted:** 2026-06-30T16:43:49.101Z
- **routing (needs):** build
