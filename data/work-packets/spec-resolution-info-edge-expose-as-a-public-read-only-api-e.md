# Work packet — Resolution-info edge → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Resolution-info edge → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:pm-resolution-edge
- **drafted:** 2026-06-30T09:04:01.437Z
- **routing (needs):** build
