# Work packet — Validator commission → cross-reference two monitors for a confluence alert

- **sig:** `spec:Validator commission → cross-reference two monitors for a confluence alert`
