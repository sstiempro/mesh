# Work packet — CEX↔DEX arbitrage → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:CEX↔DEX arbitrage → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:cex-dex-arb
- **drafted:** 2026-06-30T16:37:59.543Z
- **routing (needs):** build
