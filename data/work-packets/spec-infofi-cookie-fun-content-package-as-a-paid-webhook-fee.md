# Work packet — InfoFi / Cookie.fun content → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:InfoFi / Cookie.fun content → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp64
- **drafted:** 2026-06-29T17:52:16.855Z
- **routing (needs):** build
