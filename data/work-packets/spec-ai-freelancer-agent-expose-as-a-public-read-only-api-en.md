# Work packet — AI freelancer agent → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:AI freelancer agent → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp85
- **drafted:** 2026-06-29T16:17:35.034Z
- **routing (needs):** build
