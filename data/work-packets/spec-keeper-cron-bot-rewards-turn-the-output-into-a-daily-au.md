# Work packet — Keeper/cron bot rewards → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Keeper/cron bot rewards → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** edge:keeper-bot-rewards
- **drafted:** 2026-06-30T15:55:29.303Z
