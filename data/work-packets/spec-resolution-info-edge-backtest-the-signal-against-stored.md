# Work packet — Resolution-info edge → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Resolution-info edge → backtest the signal against stored candle history for an edge stat`
