# Work packet — IPFS/Arweave pinning → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:IPFS/Arweave pinning → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp60
- **drafted:** 2026-06-30T14:52:42.479Z
- **routing (needs):** build
