# Work packet — Run a trading bot, charge fee → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Run a trading bot, charge fee → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** edge:trading-bot-fee
- **drafted:** 2026-06-30T14:16:44.542Z
