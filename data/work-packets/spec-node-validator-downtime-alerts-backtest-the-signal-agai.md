# Work packet — Node/validator downtime alerts → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Node/validator downtime alerts → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp30
- **drafted:** 2026-06-30T19:34:56.426Z
