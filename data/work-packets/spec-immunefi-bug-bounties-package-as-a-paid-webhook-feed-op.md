# Work packet — Immunefi bug bounties → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Immunefi bug bounties → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp1
- **drafted:** 2026-06-30T16:20:29.242Z
- **routing (needs):** build
