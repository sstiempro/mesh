# Work packet — Stablecoin depeg monitor → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Stablecoin depeg monitor → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp20
- **drafted:** 2026-06-30T18:12:05.045Z
- **routing (needs):** build
