# Work packet — Onchain alert builder (no-code) → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Onchain alert builder (no-code) → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp39
- **drafted:** 2026-06-29T16:30:07.457Z
