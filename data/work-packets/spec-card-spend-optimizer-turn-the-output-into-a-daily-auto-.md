# Work packet — Card-spend optimizer → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Card-spend optimizer → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp78
- **drafted:** 2026-06-30T12:18:16.176Z
