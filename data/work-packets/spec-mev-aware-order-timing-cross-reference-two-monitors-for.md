# Work packet — MEV-aware order timing → cross-reference two monitors for a confluence alert

- **sig:** `spec:MEV-aware order timing → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp47
- **drafted:** 2026-06-29T17:35:10.922Z
- **routing (needs):** build
