# Work packet — Leveraged staking loop → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Leveraged staking loop → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:leveraged-staking-loop
- **drafted:** 2026-06-30T07:28:10.925Z
- **routing (needs):** build
