# Work packet — Gas refund / approval revoker → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Gas refund / approval revoker → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp37
- **drafted:** 2026-06-30T14:23:30.134Z
- **routing (needs):** build
