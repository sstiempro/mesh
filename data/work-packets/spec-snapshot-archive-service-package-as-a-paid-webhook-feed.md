# Work packet — Snapshot/archive service → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Snapshot/archive service → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp57
- **drafted:** 2026-06-30T18:00:14.679Z
- **routing (needs):** build
