# Work packet — Vote-bribe markets → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Vote-bribe markets → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:vetoken-bribes
- **drafted:** 2026-06-30T11:38:11.986Z
- **routing (needs):** build
