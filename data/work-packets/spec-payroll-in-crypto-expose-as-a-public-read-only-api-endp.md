# Work packet — Payroll in crypto → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Payroll in crypto → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp74
- **drafted:** 2026-06-30T12:35:36.872Z
- **routing (needs):** build
