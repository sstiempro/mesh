# Work packet — Snapshot/archive service → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Snapshot/archive service → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp57
- **drafted:** 2026-06-30T18:18:20.230Z
- **routing (needs):** build
