# Work packet — Yield+points stacking → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Yield+points stacking → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:looping-airdrop-yield
- **drafted:** 2026-06-30T20:26:58.623Z
- **routing (needs):** build
