# Work packet — Onchain reputation/attestation → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Onchain reputation/attestation → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp96
- **drafted:** 2026-06-29T16:54:29.993Z
- **routing (needs):** build
