# Work packet — Yield optimizer tool → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Yield optimizer tool → turn the output into a daily auto-posted thread (attention → audience)`
