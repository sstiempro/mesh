# Work packet — Airdrop-farming consulting → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Airdrop-farming consulting → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp92
- **drafted:** 2026-06-30T18:50:02.548Z
- **routing (needs):** build
