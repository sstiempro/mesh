# Work packet — Cointegration pairs scanner → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Cointegration pairs scanner → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp44
- **drafted:** 2026-06-30T12:00:37.382Z
