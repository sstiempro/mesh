# Work packet — Telegram sniper bot fee → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Telegram sniper bot fee → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:telegram-sniper-fee
- **drafted:** 2026-06-30T18:30:55.923Z
- **routing (needs):** build
