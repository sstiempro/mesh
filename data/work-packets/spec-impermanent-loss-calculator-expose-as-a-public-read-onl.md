# Work packet — Impermanent-loss calculator → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Impermanent-loss calculator → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp32
- **drafted:** 2026-06-29T15:10:08.417Z
- **routing (needs):** build
