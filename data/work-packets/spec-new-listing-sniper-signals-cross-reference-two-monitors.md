# Work packet — New-listing sniper signals → cross-reference two monitors for a confluence alert

- **sig:** `spec:New-listing sniper signals → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp45
- **drafted:** 2026-06-30T17:13:01.420Z
- **routing (needs):** build
