# Work packet — Futures calendar spread → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Futures calendar spread → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:calendar-spread
- **drafted:** 2026-06-30T12:12:29.040Z
- **routing (needs):** build
