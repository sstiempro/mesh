# Work packet — Vote-bribe markets → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Vote-bribe markets → expose as a public read-only API endpoint + rate-limit`
