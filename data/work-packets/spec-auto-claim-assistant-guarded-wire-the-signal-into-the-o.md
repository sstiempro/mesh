# Work packet — Auto-claim assistant (guarded) → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Auto-claim assistant (guarded) → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp82
- **drafted:** 2026-06-30T16:20:29.240Z
- **routing (needs):** build
