# Work packet — Yield-change alerts → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Yield-change alerts → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp26
- **drafted:** 2026-06-29T18:39:15.459Z
- **routing (needs):** build
