# Work packet — Node/validator downtime alerts → cross-reference two monitors for a confluence alert

- **sig:** `spec:Node/validator downtime alerts → cross-reference two monitors for a confluence alert`
