# Work packet — Sybil-detection for protocols → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Sybil-detection for protocols → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp97
- **drafted:** 2026-06-30T18:06:10.052Z
- **routing (needs):** build
