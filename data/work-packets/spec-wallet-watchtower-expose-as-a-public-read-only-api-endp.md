# Work packet — Wallet watchtower → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Wallet watchtower → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp21
- **drafted:** 2026-06-30T12:41:19.526Z
- **routing (needs):** build
