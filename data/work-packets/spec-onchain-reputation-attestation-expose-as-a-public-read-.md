# Work packet — Onchain reputation/attestation → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Onchain reputation/attestation → expose as a public read-only API endpoint + rate-limit`
