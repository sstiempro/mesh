# Work packet — Funding-rate harvest signals → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Funding-rate harvest signals → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp43
- **drafted:** 2026-06-30T12:52:52.452Z
- **routing (needs):** build
