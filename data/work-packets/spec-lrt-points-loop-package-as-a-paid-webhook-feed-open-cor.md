# Work packet — LRT points loop → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:LRT points loop → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:lrt-points-loop
- **drafted:** 2026-06-30T19:00:15.085Z
- **routing (needs):** build
