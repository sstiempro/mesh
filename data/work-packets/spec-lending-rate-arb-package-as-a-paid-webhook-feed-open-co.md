# Work packet — Lending-rate arb → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Lending-rate arb → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:lending-rate-arb
- **drafted:** 2026-06-30T07:10:30.546Z
- **routing (needs):** build
