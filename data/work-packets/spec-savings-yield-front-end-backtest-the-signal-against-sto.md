# Work packet — Savings/yield front-end → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Savings/yield front-end → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp79
- **drafted:** 2026-06-30T13:16:11.366Z
