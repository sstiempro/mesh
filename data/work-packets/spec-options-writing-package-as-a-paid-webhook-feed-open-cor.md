# Work packet — Options writing → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Options writing → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:options-writing
- **drafted:** 2026-06-30T20:33:22.603Z
- **routing (needs):** build
