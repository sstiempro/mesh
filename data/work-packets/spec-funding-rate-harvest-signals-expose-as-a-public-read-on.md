# Work packet — Funding-rate harvest signals → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Funding-rate harvest signals → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp43
- **drafted:** 2026-06-30T17:47:59.619Z
- **routing (needs):** build
