# Work packet — LST peg MM → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:LST peg MM → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:lst-peg-mm
- **drafted:** 2026-06-30T13:04:35.257Z
- **routing (needs):** build
