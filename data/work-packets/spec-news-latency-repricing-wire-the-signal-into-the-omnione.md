# Work packet — News-latency repricing → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:News-latency repricing → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:pm-news-latency
- **drafted:** 2026-06-29T17:23:43.821Z
- **routing (needs):** build
