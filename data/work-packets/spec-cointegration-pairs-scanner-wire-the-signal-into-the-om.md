# Work packet — Cointegration pairs scanner → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Cointegration pairs scanner → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp44
- **drafted:** 2026-06-30T11:54:33.844Z
- **routing (needs):** build
