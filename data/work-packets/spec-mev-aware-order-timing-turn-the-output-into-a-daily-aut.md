# Work packet — MEV-aware order timing → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:MEV-aware order timing → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp47
- **drafted:** 2026-06-30T12:00:37.379Z
