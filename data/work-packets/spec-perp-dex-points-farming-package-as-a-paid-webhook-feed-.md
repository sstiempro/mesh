# Work packet — Perp-DEX points farming → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Perp-DEX points farming → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:perp-dex-points
- **drafted:** 2026-06-29T15:10:08.415Z
- **routing (needs):** build
