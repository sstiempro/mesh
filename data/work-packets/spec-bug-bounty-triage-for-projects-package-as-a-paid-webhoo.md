# Work packet — Bug-bounty triage for projects → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Bug-bounty triage for projects → package as a paid webhook feed (open-core: free digest, pro realtime)`
