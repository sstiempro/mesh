# Work packet — DePIN earnings benchmark → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:DePIN earnings benchmark → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp17
- **drafted:** 2026-06-30T12:24:03.710Z
- **routing (needs):** build
