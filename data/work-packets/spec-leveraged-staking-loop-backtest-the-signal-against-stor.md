# Work packet — Leveraged staking loop → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Leveraged staking loop → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:leveraged-staking-loop
- **drafted:** 2026-06-30T19:22:05.699Z
