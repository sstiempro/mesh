# Work packet — Cross-chain arbitrage → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Cross-chain arbitrage → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:cross-chain-arb
- **drafted:** 2026-06-30T14:03:19.522Z
- **routing (needs):** build
