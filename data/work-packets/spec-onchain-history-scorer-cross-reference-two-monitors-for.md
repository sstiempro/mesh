# Work packet — Onchain-history scorer → cross-reference two monitors for a confluence alert

- **sig:** `spec:Onchain-history scorer → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp18
- **drafted:** 2026-06-30T15:27:06.562Z
- **routing (needs):** build
