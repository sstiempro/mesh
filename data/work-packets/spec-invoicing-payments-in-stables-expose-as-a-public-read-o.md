# Work packet — Invoicing/payments in stables → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Invoicing/payments in stables → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp72
- **drafted:** 2026-06-30T12:29:45.320Z
- **routing (needs):** build
