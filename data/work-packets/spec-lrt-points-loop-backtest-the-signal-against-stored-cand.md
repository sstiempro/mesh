# Work packet — LRT points loop → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:LRT points loop → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:lrt-points-loop
- **drafted:** 2026-06-29T17:29:26.108Z
