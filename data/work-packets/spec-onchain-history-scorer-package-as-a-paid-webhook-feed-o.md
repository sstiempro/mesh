# Work packet — Onchain-history scorer → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Onchain-history scorer → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp18
- **drafted:** 2026-06-29T16:10:49.729Z
- **routing (needs):** build
