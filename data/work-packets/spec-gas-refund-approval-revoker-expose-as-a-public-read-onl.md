# Work packet — Gas refund / approval revoker → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Gas refund / approval revoker → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp37
- **drafted:** 2026-06-30T12:41:19.525Z
- **routing (needs):** build
