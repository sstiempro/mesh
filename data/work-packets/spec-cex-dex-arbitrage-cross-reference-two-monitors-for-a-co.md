# Work packet — CEX↔DEX arbitrage → cross-reference two monitors for a confluence alert

- **sig:** `spec:CEX↔DEX arbitrage → cross-reference two monitors for a confluence alert`
- **source avenue:** edge:cex-dex-arb
- **drafted:** 2026-06-30T05:37:49.578Z
- **routing (needs):** build
