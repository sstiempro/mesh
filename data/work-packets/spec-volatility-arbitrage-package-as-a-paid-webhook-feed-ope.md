# Work packet — Volatility arbitrage → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Volatility arbitrage → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:vol-arb
- **drafted:** 2026-06-29T16:04:19.891Z
- **routing (needs):** build
