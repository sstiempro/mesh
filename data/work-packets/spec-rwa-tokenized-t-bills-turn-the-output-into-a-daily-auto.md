# Work packet — RWA / tokenized T-bills → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:RWA / tokenized T-bills → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** edge:rwa-yield
- **drafted:** 2026-06-30T09:15:31.496Z
