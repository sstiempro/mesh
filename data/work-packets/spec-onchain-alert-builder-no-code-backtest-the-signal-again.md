# Work packet — Onchain alert builder (no-code) → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Onchain alert builder (no-code) → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp39
- **drafted:** 2026-06-30T14:23:30.135Z
