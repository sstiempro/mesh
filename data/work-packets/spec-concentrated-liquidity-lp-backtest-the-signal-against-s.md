# Work packet — Concentrated-liquidity LP → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Concentrated-liquidity LP → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:concentrated-liquidity
- **drafted:** 2026-06-29T21:47:46.979Z
