# Work packet — Regime-router signals → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Regime-router signals → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp50
- **drafted:** 2026-06-30T07:10:30.544Z
- **routing (needs):** build
