# Work packet — Points arbitrage → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Points arbitrage → wire the signal into the omnione paper-sim as an entry gate`
