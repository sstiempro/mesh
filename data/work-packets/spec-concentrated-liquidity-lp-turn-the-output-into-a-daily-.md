# Work packet — Concentrated-liquidity LP → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Concentrated-liquidity LP → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** edge:concentrated-liquidity
- **drafted:** 2026-06-30T13:04:35.260Z
