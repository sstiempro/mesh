# Work packet — Vote-bribe markets → cross-reference two monitors for a confluence alert

- **sig:** `spec:Vote-bribe markets → cross-reference two monitors for a confluence alert`
- **source avenue:** edge:vetoken-bribes
- **drafted:** 2026-06-30T12:47:06.693Z
- **routing (needs):** build
