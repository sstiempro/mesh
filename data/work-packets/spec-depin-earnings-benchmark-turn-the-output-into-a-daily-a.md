# Work packet — DePIN earnings benchmark → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:DePIN earnings benchmark → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp17
- **drafted:** 2026-06-30T20:52:39.655Z
