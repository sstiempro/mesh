# Work packet — LRT points loop → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:LRT points loop → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:lrt-points-loop
- **drafted:** 2026-06-30T16:14:36.550Z
- **routing (needs):** build
