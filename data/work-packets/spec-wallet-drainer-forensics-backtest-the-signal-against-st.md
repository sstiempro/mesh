# Work packet — Wallet-drainer forensics → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Wallet-drainer forensics → backtest the signal against stored candle history for an edge stat`
