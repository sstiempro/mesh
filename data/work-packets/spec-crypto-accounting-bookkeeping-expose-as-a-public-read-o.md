# Work packet — Crypto accounting/bookkeeping → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Crypto accounting/bookkeeping → expose as a public read-only API endpoint + rate-limit`
