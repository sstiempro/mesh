# Work packet — DePIN node fleet → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:DePIN node fleet → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp54
- **drafted:** 2026-06-30T16:01:41.423Z
- **routing (needs):** build
