# Work packet — Wallet watchtower → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Wallet watchtower → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp21
- **drafted:** 2026-06-30T20:07:38.320Z
- **routing (needs):** build
