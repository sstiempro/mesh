# Work packet — NFT cross-market floor arb → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:NFT cross-market floor arb → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:nft-floor-arb
- **drafted:** 2026-06-30T12:18:16.179Z
- **routing (needs):** build
