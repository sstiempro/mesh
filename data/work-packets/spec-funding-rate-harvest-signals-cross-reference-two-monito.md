# Work packet — Funding-rate harvest signals → cross-reference two monitors for a confluence alert

- **sig:** `spec:Funding-rate harvest signals → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp43
- **drafted:** 2026-06-30T15:42:08.770Z
- **routing (needs):** build
