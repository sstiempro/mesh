# Work packet — PM liquidity provision → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:PM liquidity provision → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:pm-liquidity-provision
- **drafted:** 2026-06-29T16:04:19.892Z
- **routing (needs):** build
