# Work packet — Invoicing/payments in stables → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Invoicing/payments in stables → wire the signal into the omnione paper-sim as an entry gate`
