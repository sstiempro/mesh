# Work packet — Airdrop eligibility checker → cross-reference two monitors for a confluence alert

- **sig:** `spec:Airdrop eligibility checker → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp31
- **drafted:** 2026-06-29T15:04:05.780Z
- **routing (needs):** build
