# Work packet — Liquidation keeper → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Liquidation keeper → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:liquidation-bot
- **drafted:** 2026-06-29T21:01:33.789Z
- **routing (needs):** build
