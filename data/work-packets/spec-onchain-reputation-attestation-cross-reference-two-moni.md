# Work packet — Onchain reputation/attestation → cross-reference two monitors for a confluence alert

- **sig:** `spec:Onchain reputation/attestation → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp96
- **drafted:** 2026-06-29T16:30:07.458Z
- **routing (needs):** build
