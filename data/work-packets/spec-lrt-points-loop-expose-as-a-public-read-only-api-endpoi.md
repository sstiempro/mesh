# Work packet — LRT points loop → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:LRT points loop → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:lrt-points-loop
- **drafted:** 2026-06-30T02:28:50.836Z
- **routing (needs):** build
