# Work packet — Spatial (cross-CEX) arb → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Spatial (cross-CEX) arb → wire the signal into the omnione paper-sim as an entry gate`
