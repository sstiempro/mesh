# Work packet — Sentiment/pulse API → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Sentiment/pulse API → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp12
- **drafted:** 2026-06-30T00:50:40.072Z
