# Work packet — Telegram trading bot (fee share) → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Telegram trading bot (fee share) → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp81
- **drafted:** 2026-06-30T20:26:58.620Z
- **routing (needs):** build
