# Work packet — Yield+points stacking → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Yield+points stacking → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** edge:looping-airdrop-yield
- **drafted:** 2026-06-30T18:56:36.921Z
- **routing (needs):** build
