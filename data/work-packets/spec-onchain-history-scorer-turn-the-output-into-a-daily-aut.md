# Work packet — Onchain-history scorer → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Onchain-history scorer → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp18
- **drafted:** 2026-06-30T06:21:17.255Z
