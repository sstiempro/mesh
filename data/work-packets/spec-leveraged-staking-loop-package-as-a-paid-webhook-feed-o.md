# Work packet — Leveraged staking loop → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Leveraged staking loop → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** edge:leveraged-staking-loop
- **drafted:** 2026-06-30T13:39:43.413Z
- **routing (needs):** build
