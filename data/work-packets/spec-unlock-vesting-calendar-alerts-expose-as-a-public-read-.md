# Work packet — Unlock/vesting calendar alerts → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Unlock/vesting calendar alerts → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp23
- **drafted:** 2026-06-30T16:26:24.166Z
- **routing (needs):** build
