# Work packet — Yield+points stacking → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Yield+points stacking → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** edge:looping-airdrop-yield
- **drafted:** 2026-06-30T19:22:05.702Z
- **routing (needs):** build
