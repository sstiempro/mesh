# Work packet — Rug/scam detector API → cross-reference two monitors for a confluence alert

- **sig:** `spec:Rug/scam detector API → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp6
- **drafted:** 2026-06-29T17:58:10.931Z
- **routing (needs):** build
