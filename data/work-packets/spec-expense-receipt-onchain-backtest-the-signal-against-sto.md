# Work packet — Expense/receipt → onchain → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Expense/receipt → onchain → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp75
- **drafted:** 2026-06-30T19:00:15.084Z
