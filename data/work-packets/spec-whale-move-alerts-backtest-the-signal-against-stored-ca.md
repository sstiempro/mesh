# Work packet — Whale-move alerts → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Whale-move alerts → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp29
- **drafted:** 2026-06-30T00:50:40.070Z
