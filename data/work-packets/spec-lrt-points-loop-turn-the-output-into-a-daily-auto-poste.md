# Work packet — LRT points loop → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:LRT points loop → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** edge:lrt-points-loop
- **drafted:** 2026-06-30T15:35:03.307Z
