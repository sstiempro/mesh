# Work packet — Bug-bounty triage for projects → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Bug-bounty triage for projects → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp93
- **drafted:** 2026-06-29T17:58:10.932Z
