# Work packet — Portfolio drift/rebalance alerts → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Portfolio drift/rebalance alerts → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp28
- **drafted:** 2026-06-30T14:30:23.226Z
- **routing (needs):** build
