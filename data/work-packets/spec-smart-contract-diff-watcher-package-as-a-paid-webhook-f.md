# Work packet — Smart-contract diff watcher → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Smart-contract diff watcher → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp8
- **drafted:** 2026-06-30T00:04:21.681Z
- **routing (needs):** build
