# Work packet — News-latency repricing → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:News-latency repricing → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:pm-news-latency
- **drafted:** 2026-06-30T07:16:15.814Z
