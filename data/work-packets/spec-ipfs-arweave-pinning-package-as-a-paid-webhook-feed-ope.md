# Work packet — IPFS/Arweave pinning → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:IPFS/Arweave pinning → package as a paid webhook feed (open-core: free digest, pro realtime)`
