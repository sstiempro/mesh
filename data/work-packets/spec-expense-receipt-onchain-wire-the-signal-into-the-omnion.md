# Work packet — Expense/receipt → onchain → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Expense/receipt → onchain → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp75
- **drafted:** 2026-06-30T19:41:40.201Z
- **routing (needs):** build
