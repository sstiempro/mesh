# Work packet — Yield optimizer tool → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Yield optimizer tool → wire the signal into the omnione paper-sim as an entry gate`
- **source avenue:** system:sp35
- **drafted:** 2026-06-30T09:09:42.798Z
- **routing (needs):** build
