# Work packet — Subscription-billing in crypto → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Subscription-billing in crypto → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp77
- **drafted:** 2026-06-30T08:58:15.330Z
- **routing (needs):** build
