# Work packet — Compliance/tax-lot reporter → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Compliance/tax-lot reporter → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp80
- **drafted:** 2026-06-30T17:54:04.921Z
