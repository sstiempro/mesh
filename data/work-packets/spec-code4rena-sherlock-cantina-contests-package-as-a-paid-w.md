# Work packet — Code4rena/Sherlock/Cantina contests → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Code4rena/Sherlock/Cantina contests → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp2
- **drafted:** 2026-06-29T15:27:48.498Z
- **routing (needs):** build
