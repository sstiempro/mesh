# Work packet — Crypto tax helper → cross-reference two monitors for a confluence alert

- **sig:** `spec:Crypto tax helper → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp33
- **drafted:** 2026-06-29T16:48:33.391Z
- **routing (needs):** build
