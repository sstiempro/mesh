# Work packet — Wallet bundle/health scanner → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Wallet bundle/health scanner → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp36
- **drafted:** 2026-06-30T20:58:58.949Z
- **routing (needs):** build
