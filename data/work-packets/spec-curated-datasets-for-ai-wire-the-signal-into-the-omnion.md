# Work packet — Curated datasets for AI → wire the signal into the omnione paper-sim as an entry gate

- **sig:** `spec:Curated datasets for AI → wire the signal into the omnione paper-sim as an entry gate`
