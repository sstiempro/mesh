# Work packet — Grant-writing as a service → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Grant-writing as a service → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** system:sp91
- **drafted:** 2026-06-29T17:35:10.924Z
