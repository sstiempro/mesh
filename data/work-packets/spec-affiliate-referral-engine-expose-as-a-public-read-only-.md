# Work packet — Affiliate/referral engine → expose as a public read-only API endpoint + rate-limit

- **sig:** `spec:Affiliate/referral engine → expose as a public read-only API endpoint + rate-limit`
- **source avenue:** system:sp69
- **drafted:** 2026-06-30T09:27:13.613Z
- **routing (needs):** build
