# Work packet — Data-availability/relayer node → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Data-availability/relayer node → backtest the signal against stored candle history for an edge stat`
