# Work packet — Self-host bot hosting → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Self-host bot hosting → backtest the signal against stored candle history for an edge stat`
- **source avenue:** system:sp56
- **drafted:** 2026-06-30T12:35:36.869Z
