# Work packet — Cross-chain arbitrage → turn the output into a daily auto-posted thread (attention → audience)

- **sig:** `spec:Cross-chain arbitrage → turn the output into a daily auto-posted thread (attention → audience)`
- **source avenue:** edge:cross-chain-arb
- **drafted:** 2026-06-30T20:14:03.647Z
