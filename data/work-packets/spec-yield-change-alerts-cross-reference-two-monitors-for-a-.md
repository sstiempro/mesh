# Work packet — Yield-change alerts → cross-reference two monitors for a confluence alert

- **sig:** `spec:Yield-change alerts → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp26
- **drafted:** 2026-06-30T07:33:54.612Z
- **routing (needs):** build
