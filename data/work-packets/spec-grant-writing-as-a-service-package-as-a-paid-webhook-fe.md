# Work packet — Grant-writing as a service → package as a paid webhook feed (open-core: free digest, pro realtime)

- **sig:** `spec:Grant-writing as a service → package as a paid webhook feed (open-core: free digest, pro realtime)`
- **source avenue:** system:sp91
- **drafted:** 2026-06-30T14:09:51.162Z
- **routing (needs):** build
