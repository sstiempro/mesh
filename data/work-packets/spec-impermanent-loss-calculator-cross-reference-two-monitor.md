# Work packet — Impermanent-loss calculator → cross-reference two monitors for a confluence alert

- **sig:** `spec:Impermanent-loss calculator → cross-reference two monitors for a confluence alert`
- **source avenue:** system:sp32
- **drafted:** 2026-07-01T11:14:32.326Z
- **routing (needs):** build
