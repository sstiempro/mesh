# Work packet — Yield+points stacking → backtest the signal against stored candle history for an edge stat

- **sig:** `spec:Yield+points stacking → backtest the signal against stored candle history for an edge stat`
- **source avenue:** edge:looping-airdrop-yield
- **drafted:** 2026-06-30T14:59:35.316Z
